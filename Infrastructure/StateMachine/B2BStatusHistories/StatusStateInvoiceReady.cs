...
{
    public class StatusStateInvoiceReady : StatusStateBase
    {
        public StatusStateInvoiceReady(B2BContext context, B2BStatusHistory b2BStatusHistory) :
            base(context, b2BStatusHistory)
        {
        }

        protected override B2BStatusTypeNames MyStatus => B2BStatusTypeNames.InvoiceReady;

        public override StateMachineMoveResult CanMoveTo(B2BStatusTypeNames nextStatus)
        {
            return nextStatus == B2BStatusTypeNames.Invoicing || nextStatus == MyStatus
