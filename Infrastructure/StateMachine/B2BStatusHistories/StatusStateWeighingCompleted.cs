...
{
    public class StatusStateWeighingCompleted : StatusStateBase
    {
        public StatusStateWeighingCompleted(B2BContext context, B2BStatusHistory b2BStatusHistory) :
            base(context, b2BStatusHistory)
        {
        }

        protected override B2BStatusTypeNames MyStatus => B2BStatusTypeNames.WeighingCompleted;
