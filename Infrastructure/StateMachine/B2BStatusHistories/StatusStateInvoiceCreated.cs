...
{
    public class StatusStateInvoiceCreated : StatusStateBase
    {
        public StatusStateInvoiceCreated(B2BContext context, B2BStatusHistory b2BStatusHistory) :
            base(context, b2BStatusHistory)
        {
        }

        protected override B2BStatusTypeNames MyStatus => B2BStatusTypeNames.InvoiceCreated;
        ...
        public override StateMachineMoveResult CanMoveTo(B2BStatusTypeNames nextStatus)
        {
            return nextStatus == MyStatus
                ...
                StateMachineMoveResult.False(
                    string.Format(StateMachineMessages.CantMoveNextFromInvoiceCreatedErrorMessage));
        }
    }
}